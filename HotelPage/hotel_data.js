var hotelsDataObj=[
    {hotelPic:"https://a.travel-assets.com/media/meso_cm/PAPI/Images/hotels/1000000/700000/697000/696977/52c154f9_b.jpg",
     ...
     rating:"3.0/5",
     hotelFees:"Rs 8,100",
     totalFees:"Rs 9,558 total",
    },
    {hotelPic:"https://a.travel-assets.com/media/meso_cm/PAPI/Images/hotels/16000000/15520000/15518800/15518705/61ac74e1_b.jpg ",
...
hotelsDataObj.forEach(function(elem){
    ...
    hotel_img.setAttribute("src",elem.hotelPic)
    
    var detailsBox=document.createElement("div")
    detailsBox.setAttribute("id","details")

    var hotel_name=document.createElement("h2")
    hotel_name.innerText=elem.hotelName

    var hotel_tag=document.createElement("p")
    hotel_tag.innerText=elem.hotelTag

    var innerBox=document.createElement("div")
    var hotel_desc=document.createElement("p")
    hotel_desc.innerText=elem.hotelDesc

    var hotel_offer=document.createElement("p")
    hotel_offer.innerText=elem.hotelOffer

    var hotel_rating=document.createElement("h3")
    hotel_rating.innerText=elem.rating
    ...
    hotel_fees.innerText=elem.hotelFees
    var total_fees=document.createElement("p")
    total_fees.innerText=elem.totalFees

    box.append(hotel_img)
    innerBox.append(hotel_desc,hotel_offer)
    detailsBox.append(hotel_name,hotel_tag,innerBox,hotel_rating)
    priceList.append(hotel_fees,total_fees)
    priceBox.append(priceList)
